...
/**
 * Draw the current video frame onto the canvas and optionally mirror it
 * for selfie view. When mirrored, set a persistent transform so all
 * subsequent overlay drawing aligns with the mirrored video.
 *
