...
export const TASK_META: Record<VisionTaskId, VisionTaskMeta> = {
  ...
  'gesture-recognition': {
    ...
    description:
      'Recognize hand gestures (thumbs up, peace, fist, etc.).',
    modelUrl:
  ...
  'image-segmentation': {
    ...
    description: 'Segment the scene into semantic regions with colored overlays.',
    modelUrl:
  ...
  'interactive-segmentation': {
    ...
    description:
      'Click a point on a captured image to segment that region. Image-only mode.',
    modelUrl:
